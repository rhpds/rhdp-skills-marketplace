...
To create validation roles for Red Hat Demo Platform (RHDP) workshops and demos, follow this workflow. This skill follows a **collaborative pattern** — the developer runs commands manually and shares output.
