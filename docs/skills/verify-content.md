...
<div class="workflow-diagram">
  <a href="verify-content-workflow.svg" target="_blank">
    <img src="verify-content-workflow.svg" alt="verify-content workflow diagram" style="max-width: 100%; height: auto; border-radius: 8px; border: 1px solid #e1e4e8;" />
  </a>
